...
If implementation exposes an unplanned design choice, ambiguous ownership, or an unproven root cause, stop that work unit and report the evidence to the supervising main session. Do not guess through it.
