...
pub use prompt::{effective_interval, openai_base_url, preview_prompts};
...
use prompt::{
    anthropic_base_url, effective_cli_kind, effective_http_protocol, effective_method,
    effective_model, effective_timeout, select_prompt,
};
use std::{
    fs,
