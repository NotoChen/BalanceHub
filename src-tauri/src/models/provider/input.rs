...
use crate::models::{
    ...
    AuthMode, LivenessIntervalMode, LivenessPromptMode, ProviderKind, ProviderNotificationMode,
...
impl Provider {
    pub fn from_input(input: ProviderInput, id: String) -> Self {
        ...
        Self {
            identity: ProviderIdentity {
                ...
                provider_kind: input.identity.provider_kind,
    ...
    pub fn apply_input(&mut self, input: ProviderInput) {
        ...
        self.identity.provider_kind = input.identity.provider_kind;
