...
<template>
  <a-config-provider :locale="zhCN">
    ...
    <WorkspacePickerModal
      ...
      v-model:selected-session-id="app.workspaceSelectedSessionId"
      ...
      :sessions="app.workspaceSessions"
      :sessions-loading="app.workspaceSessionsLoading"
      :session-error="app.workspaceSessionError"
