  ...
  <a-config-provider :locale="zhCN">
    <div class="app-shell" @click="app.closeProviderContextMenu" @contextmenu.prevent>
      <AppWorkspace
        ...
        :checking-in-provider-id="app.checkingInProviderId"
        :syncing-capabilities-provider-id="app.syncingCapabilitiesProviderId"
        ...
        @sync-capabilities="app.syncProviderCapabilitiesFromMenu"
